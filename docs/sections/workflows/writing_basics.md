...
First, we will write a very simple work chain, from there, we will modify it introducing new features.
...
Basically, our first work chain did not create any data, but just passed the input as the output.
