...
.. note:: *If you still have enough time, you might want to first check*
          :numref:`Appendix %s <2019_sintef_workflow_logic>` *before continuing with this section.*
...
the expected output band structures are plotted in :numref:`2019_sintef_fig_calc_bands_1`
to :numref:`2019_sintef_fig_calc_bands_4`.

.. _2019_sintef_fig_calc_bands_1:
.. figure:: include/images/bandstructures/Al_bands.png
   :width: 100%

   Electronic band structures of Al computed with AiiDA’s PwBandsWorkChain

.. _2019_sintef_fig_calc_bands_2:
