...
.. note::
    When used without the ``--config`` option, ``verdi computer setup`` will prompt you for the required information, just like you have seen when :ref:`setting up a profile<2019_sintef_setup_verdi_quicksetup>`.
    ...
    as explained in :ref:`this appendix<2019_sintef_appendix_computer_code_setup>`.
