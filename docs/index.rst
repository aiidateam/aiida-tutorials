...
|                 | `this Quantum Mobile release <https://github.com/marvel-nccr/quantum-mobile/releases/tag/20.06.1>`__                 |
+-----------------+----------------------------------------------------------------------------------------------------------------------+
...
.. toctree::
    ...
    ./source/sections/setup
    ./source/sections/basics
    ./source/sections/running
    ./source/sections/data
    ./source/sections/workflows_basic
    ./source/sections/bands
    ./source/sections/workflows_adv
    ./source/sections/plugins
    ./source/sections/retrieve_data
...
.. toctree::
   ...
   ./source/appendices/exploring_provenance
   ./source/appendices/input_validation
   ./source/appendices/workflow_logic
...
.. image:: source/sponsors/swissuniversities.png
...
.. image:: source/sponsors/marketplace.png
   :target: https://www.the-marketplace-project.eu/
   :width: 145px

.. image:: source/sponsors/intersect.png
   :target: http://intersect-project.eu/
   :width: 125px

.. image:: source/sponsors/pasc.png
